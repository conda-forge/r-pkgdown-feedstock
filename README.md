...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3435&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-pkgdown-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-pkgdown` can be installed with `conda`:
...
```
mamba install r-pkgdown
```

It is possible to list all of the versions of `r-pkgdown` available on your platform with `conda`:
...
```
mamba search r-pkgdown --channel conda-forge
```
...
mamba repoquery search r-pkgdown --channel conda-forge

# List packages depending on `r-pkgdown`:
mamba repoquery whoneeds r-pkgdown --channel conda-forge

# List dependencies of `r-pkgdown`:
mamba repoquery depends r-pkgdown --channel conda-forge
```
